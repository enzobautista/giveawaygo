...
Game.create([{gtype: "Website Go", quantity: 3, code: 46}, {gtype: "Sponsors Go", quantity: 3, code: 39}, {gtype: "Summit Go", quantity: 3, code: 89}, {gtype: "CIO Members Go", quantity: 3, code: 76}])
